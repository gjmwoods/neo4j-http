...
public class ASTFactoryImpl implements ASTFactory<ASTFactory.NULL,
        ASTFactory.NULL,
        ASTFactory.NULL,
        ASTFactory.NULL,
        ASTFactory.NULL,
    ...
    public boolean getHasSeenCallInTx() {
        return hasSeenCallInTx.get();
    }

    public boolean getHasSeenPeriodicCommit()
    {
        return hasSeenPeriodicCommit.get();
    }
